...
Une **ressource** possède une URI et un type de contenu. Elle convient aux données que l'application choisit d'ajouter au contexte. Une documentation ou le schéma d'une base ne devrait pas devenir un outil artificiel si sa finalité est simplement d'être lu.
